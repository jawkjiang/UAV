...
def compute_all_metrics(y_true: np.ndarray,
                       ...
                       flight_ids: np.ndarray,
                       attack_types: np.ndarray,
                       attack_segments_info: list = None) -> Dict:
    """
    ...
    Args:
        ...
        attack_segments_info: Optional list of dicts with 'flight_id', 'attack_type', 'attack_start_time'
    
    Returns:
        Dictionary with all metrics
    """
    # Identify attack segments
    if attack_segments_info:
        segments = identify_attack_segments_with_timing(
            y_true, timestamps, flight_ids, attack_types, attack_segments_info
        )
        delays, detected = calculate_detection_delay_v2(y_pred, timestamps, segments)
    else:
